    ...
    return (
        <div className="cta-hablemos">
            <SEOHelmet 
                ...
                keywords="movimiento naluum, naluum, movimiento, naluum movimiento, movimiento naluum, naluum movimiento, movimiento naluum, naluum movimiento, movimiento naluum, naluum movimiento, movimiento naluum, naluum movimiento, movimiento naluum, naluum movimiento, movimiento naluum, naluum movimiento, movimiento naluum, naluum movimiento, movimiento naluum, naluum movimiento"
                    ...
                    <div className="cta-hablemos__left">
                        <div class="image-wrapper">
                            <div class="image-container">
                                <img src="/img/tierra_martinez.jpg" alt="Foto de perfil" class="image" />
                            </div>
                        </div>
